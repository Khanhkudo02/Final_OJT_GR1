  ...
  return (
    <div>
      <div className="PDF-Button">
        ...
        <select className="select-CV" onChange={handleTemplateChange} value={selectedTemplate}>
          <option className="option-CV" value="">Select a template</option>
          <option className="option-CV" value="Template1">Template 1</option>
          <option className="option-CV" value="Template2">Template 2</option>
        </select>
