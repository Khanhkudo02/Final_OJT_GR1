    ...
    <div className="container">
      <div className="left">
        ...
        <div className="image-container">
          <img className="image" src="/public/images/avatar.jpg" alt="Profile" />
        </div>
        {/* Info */}
      ...
      <div className="right">
        ...
        <div className="section bottom-right">
          ...
          <ul className="list">
            <li className="list-item">
              <p className="text">Senior Graphic Designer at GlowPixel Ltd, Orlando (2015 - 2016)</p>
              <p className="text">Customer-oriented Graphic Designer with a strong history...</p>
            </li>
            <li className="list-item">
              <p className="text">Graphic Designer at Lorem Ipsum, New York (2014 - 2015)</p>
              <p className="text">Customer-oriented Graphic Designer with a strong history...</p>
            </li>
            <li className="list-item">
              <p className="text">Graphic & Web Designer at Pixelate Agency, New Jersey (2013 - 2014)</p>
              <p className="text">Customer-oriented Graphic Designer with a strong history...</p>
            </li>
          </ul>
        </div>
        ...
        <div className="section bottom-right">
          ...
          <ul className="list">
            <li className="list-item">
              <p className="text">Master in Web Develop at University of UK, Toronto (2010 - 2012)</p>
              <p className="text">Customer-oriented Graphic Designer with a strong history...</p>
            </li>
            <li className="list-item">
              <p className="text">Bachelor in Graphic Design at College of Art, New Ark (2006 - 2010)</p>
              <p className="text">Customer-oriented Graphic Designer with a strong history...</p>
            </li>
          </ul>
        </div>
        ...
        <div className="section bottom-right">
          ...
          <div className="skills">
            <div className="skill">
              ...
              <div className="skill-bar"><div className="skill-level" style={{ width: '80%' }} /></div>
            </div>
            <div className="skill">
              <p className="text">Adobe Illustrator</p>
              <div className="skill-bar"><div className="skill-level" style={{ width: '75%' }} /></div>
            </div>
            <div className="skill">
              <p className="text">Adobe InDesign</p>
              <div className="skill-bar"><div className="skill-level" style={{ width: '70%' }} /></div>
            </div>
            <div className="skill">
              <p className="text">HTML/CSS</p>
              <div className="skill-bar"><div className="skill-level" style={{ width: '85%' }} /></div>
            </div>
            <div className="skill">
              <p className="text">WordPress</p>
              <div className="skill-bar"><div className="skill-level" style={{ width: '60%' }} /></div>
            </div>
          </div>
        </div>
        {/* Hobbies */}
        ...
        <div className="section bottom-right">
          ...
          <p className="text">Complex cognition: The psychology of human thought, Oxford University Press, New York, NY, 2001</p>
        </div>
      </div>
    </div>
  )
